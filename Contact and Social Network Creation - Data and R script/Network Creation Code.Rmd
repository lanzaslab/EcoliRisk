...
Here we use the findDistThresh function from the "contact" R package (v.1.2.6) to identify what spatial thresholds for contact likely report the majority of contacts in the calves system, previously defined as instances where individuals were within 0.5 m of one another for point-location-based contacts (Farthing et al. 2020). Note that the accuracy of the RTLS used to collect the calves data was said to be "90% of points fall within 0.5 m of true locations" (Farthing et al. 2020).
...
contactThresh.point_99<-unname(signif(contactThresh.point$CI_upper[11], 2))  #round the 99-percent CI value to 2 decimal places
...
for(i in 1:100){
  ...
  data1 <- data2017_10SecAgg.rand[[i]] #pull a single randomized set from the list. 
...
for(i in 1:100){
  ...
  data1 <- data2018_10SecAgg.rand[[i]] #pull a single randomized set from the list. 
